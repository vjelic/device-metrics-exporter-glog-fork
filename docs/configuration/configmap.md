...
```bash
helm install exporter https://github.com/ROCm/device-metrics-exporter/releases/download/v1.2.1/device-metrics-exporter-charts-v1.2.1.tgz -n metrics-exporter -f values.yaml --create-namespace
```
