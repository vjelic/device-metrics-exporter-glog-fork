...
type MetricsServiceClient interface {
	...
	List(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GPUStateResponse, error)
...
func (c *metricsServiceClient) List(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GPUStateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GPUStateResponse)
...
type MetricsServiceServer interface {
	...
	List(context.Context, *empty.Empty) (*GPUStateResponse, error)
...
func (UnimplementedMetricsServiceServer) List(context.Context, *empty.Empty) (*GPUStateResponse, error) {
...
func _MetricsService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricsServiceServer).List(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
