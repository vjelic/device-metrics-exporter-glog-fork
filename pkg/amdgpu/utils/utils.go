...
// IsKubernetes - return only if it deployed through operator or stand alone
// helm, running otherwise is to default to slurm job deployment or linux
// installation on a kubernets node is conflicting with socket file presence.
